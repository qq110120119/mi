var glass = (function () {
        ...
        return {
            ...
            init: function (x) {
                this.Multiple = x || 2;
                // 获取最大的盒子
                this.$box = document.querySelector('.box_img');
                // 获取展示图片的盒子
            ...
            event: function () {
                ...
                this.$showImage.onmouseenter = function () {
                    ...
                    _this.$showBigImage.querySelector('img').style.width = this.offsetWidth * _this.Multiple + 'px';
                     _this.$showBigImage.querySelector('img').style.height = this.offsetWidth * _this.Multiple + 'px';
                }
                ...
                this.$showImage.onmousemove = function (ev) {
                    ...
                    var y = ev.clientY - this.offsetTop - _this.$filter.offsetHeight-_this.$filter.offsetHeight/2;
                    // 获取小方块移动的最大坐标
